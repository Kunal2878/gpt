...
function Landingpage() {
  ...
  return (
    ...
    <Link href="components/user-chat" className={` ${sty1} hover:scale-125 md:w-40 w-32 h-10 rounded-full text-[14px] md:text-[16px] bg-white font-semibold transition-all delay-200`}>Try now
    <Image
